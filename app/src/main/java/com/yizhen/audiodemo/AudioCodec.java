...
public class AudioCodec {
    ...
    public AudioCodec(){
        Log.w("zhen", "mAudioCodec=" + mAudioCodec);
    }
...
//        Log.w("zhen", "mAudioCodec=" + mAudioCodec);
        System.out.print("mAudioCodec=" + mAudioCodec);
        if (mAudioCodec == null)
...
//        new Thread(new EncodeRunnable()).start();
    ...
    private void putPCMData(byte[] pcmChunk) {
        ...
        for(int i = 0; i < chunkPCMDataContainer.size(); i++){
            Log.e("zhenzhu", "数据" + i + "=" + chunkPCMDataContainer.get(i));
        }
    ...
    private void srcAudioFormatToPCM() {
        ...
        Log.e("zhen", "解码{@link #srcPath}音频文件 得到PCM数据块");
